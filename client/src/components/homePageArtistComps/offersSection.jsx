...
export default function OffersSection() {
  ...
  const [offerToEditId, setOfferToEditId] = useState();
  ...
  useEffect(() => {
    const appliedOffersArray = offers?.filter((offer) =>
      offer.applicants.some((applicant) => applicant?._id === user?._id)
    );
  ...
  const handleToggleEditForm = (offerId) => {
    setOfferToEditId(offerId);
          ...
          <div className="fixed inset-0 p-4 bg-gray-600 bg-opacity-50 z-50 flex justify-center items-center pt-10">
            <div className="bg-white w-[500px]  p-4 rounded-lg shadow-lg relative max-w-lg mx-auto">
              ...
              <img
                ...
                alt="Offer"
                className="w-full h-auto object-cover md:h-48"
              />
              <p className="mt-2">
              ...
              <p>
                ...
                {selectedOffer.skillsRequired.join(", ")}
              </p>
